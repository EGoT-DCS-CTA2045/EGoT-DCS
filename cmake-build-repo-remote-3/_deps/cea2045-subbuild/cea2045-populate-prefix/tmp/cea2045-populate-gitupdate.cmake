...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/epri-dev/CTA-2045-UCM-CPP-Library.git'")
  endif()
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/home/pi/Documents/EGoT-DCS/cmake-build-repo-remote-3/_deps/cea2045-src'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/pi/Documents/EGoT-DCS/cmake-build-repo-remote-3/_deps/cea2045-src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
